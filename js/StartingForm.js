...
function positionElements(){
    onlineButton.position(width/2-200, height/2-100);
    friendsButton.position(width/2+200, height/2-100);
    twoButton.position(width/2-200, height/2-100);
    threeButton.position(width/2, height/2-100);
