...
var car1_img, car2_img, car3_img, car4_img, track, fuelImage,powerCoinImage,obstacle1Image,obstacle2Image, lifeImage, blastImg;
...
function preload() {
  ...
  fuelImage = loadImage("./assets/Fuel1.png");
